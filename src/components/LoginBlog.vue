    ...
    <div>
        <canvas id="canvas"></canvas>
           ...
           <el-form-item prop="phone" >
               <el-input v-model="loginRules.phone" placeholder="请输入手机号码" class="inputs"></el-input>
           </el-form-item>
           <el-form-item prop="password">
               <el-input type="password" v-model="loginRules.password" placeholder="请输入密码" class="i-inputs"></el-input>
           </el-form-item>
    ...
    methods:{
       submitlogin(){
           this.$refs.loginRules.validate((valid)=>{
               if(valid){
                  this.postRequest('/login/cellphone',{
